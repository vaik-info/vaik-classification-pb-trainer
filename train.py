...
from model import efficientnetv2b0_model
...
def train(train_input_dir_path, valid_input_dir_path, classes_txt_path, epochs, step_size, batch_size, valid_step_size, test_max_sample_per_classes, image_size, output_dir_path, model_name='MobileNetV2'):
    # Download data
    ...
    # prepare model
    model = efficientnetv2b0_model.prepare(len(classes), image_size, fine=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes_path', type=str, default='~/.vaik-mnist-classification-dataset/classes.txt')
    parser.add_argument('--epochs', type=int, default=10)
    parser.add_argument('--step_size', type=int, default=100)
    parser.add_argument('--batch_size', type=int, default=8)
    parser.add_argument('--valid_step_size', type=int, default=1000)
    ...
    args.classes_path = os.path.expanduser(args.classes_path)
    args.output_dir_path = os.path.expanduser(args.output_dir_path)

    os.makedirs(args.output_dir_path, exist_ok=True)
    train(args.train_input_dir_path, args.valid_input_dir_path, args.classes_path,
          args.epochs, args.step_size, args.batch_size, args.valid_step_size, args.test_max_sample_per_classes, (args.image_height, args.image_width), args.output_dir_path)
